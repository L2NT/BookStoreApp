...
fun MainScreen() {
    ...
    // WishlistViewModel hoist tại MainScreen — chia sẻ state cho BookDetailScreen + WishlistScreen
            ...
            navigation(
                ...
                composable(
                    ...
                    BookDetailScreen(
                        ...
                        cartViewModel        = cartViewModel,
                        wishlistViewModel    = wishlistViewModel,  // ← thêm mới
